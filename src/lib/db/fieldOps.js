  ...
  async getWeeklyDisposalSummary(projectId, weeks = 4) {
    ...
    data?.forEach(row => {
      ...
      if (!weeklyData[weekKey]) {
        weeklyData[weekKey] = { week: weekKey, concrete: 0, trash: 0, metals: 0, hazardous_waste: 0, copper: 0, asphalt: 0 }
      }
      if (weeklyData[weekKey][row.load_type] === undefined) weeklyData[weekKey][row.load_type] = 0

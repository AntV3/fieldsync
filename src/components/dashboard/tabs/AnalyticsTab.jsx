 ...
 *    (hidden via showHealthOverview when the Overview tab already shows it)
...
export default function AnalyticsTab({
  ...
  const { forecast, cashFlow, resourceData, projections } = useProjectAnalytics({
    selectedProject,
    projectData,
    progress,
    billable,
  ...
  return (
    <div className="pv-tab-panel analytics-tab animate-fade-in">
      {/* Project Health Overview (shown on the Overview tab when hidden here) */}
      {showHealthOverview && (

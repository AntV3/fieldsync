...
export default function TMClientSignature({
  ...
  const t = {
    en: {
      ...
      certification: 'By signing, I acknowledge that the work described in this Time & Material ticket was performed as documented.',
    ...
    es: {
      ...
      certification: 'Al firmar, reconozco que el trabajo descrito en este ticket de Tiempo y Material fue realizado como se documenta.',

-- ============================================================
-- COMPREHENSIVE FIX FOR AMBIGUOUS PROJECT_ID ERROR
-- ============================================================
-- Date: 2026-01-17
...
-- 2. Drops ALL potentially problematic policies
...
-- Drop ALL project policies (every possible name from all migrations)
